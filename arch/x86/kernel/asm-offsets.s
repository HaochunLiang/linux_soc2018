...
# -march=i686 -auxbase-strip arch/x86/kernel/asm-offsets.s -Os -Wall
...
# -fshort-wchar -fcf-protection=none -freg-struct-return -fno-pic
...
# --param allow-store-data-races=0 -fstack-clash-protection
...
# -maccumulate-outgoing-args -malign-stringops -mfp-ret-in-387 -mglibc
...
.ascii "->saved_context_gdt_desc $34 offsetof(struct saved_context, gdt_desc)"	#
# 0 "" 2
...
.ascii "->"
# 0 "" 2
# arch/x86/kernel/asm-offsets_32.c:50: 	DEFINE(TSS_sysenter_sp0, offsetof(struct cpu_entry_area, tss.x86_tss.sp0) -
# 50 "arch/x86/kernel/asm-offsets_32.c" 1
	
.ascii "->TSS_sysenter_sp0 $4 offsetof(struct cpu_entry_area, tss.x86_tss.sp0) - offsetofend(struct cpu_entry_area, entry_stack_page.stack)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets_32.c:58: 	BLANK();
# 58 "arch/x86/kernel/asm-offsets_32.c" 1
	
.ascii "->"
# 0 "" 2
# arch/x86/kernel/asm-offsets_32.c:59: 	DEFINE(__NR_syscall_max, sizeof(syscalls) - 1);
# 59 "arch/x86/kernel/asm-offsets_32.c" 1
	
.ascii "->__NR_syscall_max $384 sizeof(syscalls) - 1"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets_32.c:60: 	DEFINE(NR_syscalls, sizeof(syscalls));
# 60 "arch/x86/kernel/asm-offsets_32.c" 1
	
.ascii "->NR_syscalls $385 sizeof(syscalls)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets_32.c:61: }
#NO_APP
	ret	
	.size	foo, .-foo
	.globl	common
