...
{
	sched_preempt_enable_no_resched();
	pr_info("schedule_preempt_disabled||sched_preempt_enable_no_resched\n");
	schedule();
	pr_info("schedule_preempt_disabled||schedule\n");
	preempt_disable();
	pr_info("schedule_preempt_disabled||preempt_disable\n");
}
